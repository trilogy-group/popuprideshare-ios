...
- (instancetype)initWithDelegate:(id<PickerAddressDelegate>)delegate addressFieldType:(RAPickerAddressFieldType)pickerAddressFieldType previousAddress:(NSString *)previousAddress currentAddress:(NSString *)currentAddress andMapView:(GMSMapView *)mapView;
